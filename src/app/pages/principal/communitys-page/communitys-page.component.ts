...
@Component({
	selector: 'app-communitys-page',
	templateUrl: './communitys-page.component.html',
	styleUrls: ['./communitys-page.component.scss']
})
export class CommunitysPageComponent implements OnInit, OnDestroy {
